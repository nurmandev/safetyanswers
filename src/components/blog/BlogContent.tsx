          ...
          <div className="lg:col-span-8 space-y-6 lg:space-y-10">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4 sm:mb-5">
                <svg className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-amber-500" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2l3.09 6.26L20 9.27l-5 4.87 1.18 6.88L10 16.51l-6.18 3.25L5 14.14l-5-4.87 6.91-1.01L10 2z" /></svg>
