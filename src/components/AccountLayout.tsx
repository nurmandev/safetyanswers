  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col lg:flex-row lg:overflow-hidden">
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 flex h-10 w-10 items-center justify-center bg-[#7c3aed] text-white shadow-lg"
      >
        {sidebarOpen ? (
          <svg
            className="h-6 w-6"
      ...
      <aside
        className={`fixed lg:static top-0 left-0 h-screen lg:h-auto w-72 bg-white border-r border-slate-100 z-40 lg:z-auto transition-transform duration-300 transform ${
