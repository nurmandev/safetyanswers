...
const sidebarGroups = [
 ...
 {
 href: "/admin/professional-writing",
...
function AdminLayoutInner({
 ...
 {/* â”€â”€ Sidebar â”€â”€ */}
 <aside
 className={`fixed inset-y-0 left-0 z-50 flex flex-col justify-between bg-white dark:bg-[#0c0c0e] border-r border-slate-100 dark:border-[#1a1a1f] transition-all duration-300 ease-out shadow-2xl lg:shadow-none ${
 collapsed ? "w-16" : "w-[84vw] max-w-[320px]"
 } ${mobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"} lg:sticky lg:h-screen lg:top-0 lg:w-64`}
 >
 ...
 <Link
 href="/admin/posts"
 className="block px-4 py-2.5 hover:bg-slate-50 dark:hover:bg-[#131317] font-semibold text-slate-700 dark:text-slate-300"
 onClick={() => setShowQuickActions(false)}
 >
 Create Blog Post
 </Link>
 ...
 <Link href="/admin/health" className="hover:text-slate-700">
 System Health
 </Link>
 </div>
 </footer>
