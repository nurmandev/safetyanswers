    ...
    return (
      <AccountLayout currentPath="/account">
        <div className="space-y-4 sm:space-y-6 lg:space-y-8">
          <div className="h-48 animate-pulse rounded-2xl bg-slate-200/80 dark:bg-[#1a1a1f]" />
          <div className="grid gap-3 sm:gap-4 md:grid-cols-2 xl:grid-cols-4">
            {Array.from({ length: 4 }).map((_, index) => (
              <div
                key={index}
                className="h-24 animate-pulse rounded-2xl bg-slate-200/80 dark:bg-[#1a1a1f]"
              />
            ))}
          </div>
          <div className="grid gap-4 lg:grid-cols-12">
            <div className="lg:col-span-8 space-y-4">
              <div className="h-56 animate-pulse rounded-2xl bg-slate-200/80 dark:bg-[#1a1a1f]" />
              <div className="h-56 animate-pulse rounded-2xl bg-slate-200/80 dark:bg-[#1a1a1f]" />
            </div>
      ...
      >
        ...
        <div className="grid gap-4 sm:gap-6 lg:gap-8 lg:grid-cols-12 items-start">
              ...
              <Card className="overflow-hidden">
                ...
                <div className="lg:hidden p-4 space-y-3">
                  {userConsultations.map((c, i) => (
                    <div
                      key={i}
                      className="rounded-xl border border-slate-200 dark:border-[#1a1a1f] bg-slate-50/70 dark:bg-[#121215]/50 p-4"
                    >
          ...
          <div className="lg:col-span-4 space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            {/* 13. Account Progress */}
            <motion.div variants={itemVariants}>
              <SectionHeader title="Account Progress" />
