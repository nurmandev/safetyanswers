    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-[440px]">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Sign in to the admin control panel</p>
        </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                placeholder="admin@safetyanswers.com"
                required
              />
            </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ...
          <Link href="/" className="font-bold text-[#7c3aed] hover:underline">
            Back to site
          </Link>
        </p>
      </div>
