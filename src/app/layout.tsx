...
}>) { return (<html lang="en" className={`${rency.variable} h-full antialiased`}><body className="min-h-full flex flex-col bg-slate-50 text-slate-900"><Toaster position="top-right" richColors closeButton toastOptions={{ style: { borderRadius: 0 } }} /><AuthProviders><LayoutWrapper>{children}</LayoutWrapper></AuthProviders></body></html>);
}
