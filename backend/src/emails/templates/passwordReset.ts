    ...
    <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto;">
      ...
      <div style="padding: 32px 24px; background: #ffffff; border: 1px solid #e2e8f0;">
        ...
        <p style="color: #475569; line-height: 1.6; font-size: 14px;">
          You requested a password reset. Click the button below to set a new password. If you didn't make this request, you can ignore this email.
        </p>
        <div style="text-align: center; margin: 28px 0;">
          <a href="${url}" style="background: #7c3aed; color: white; padding: 12px 32px; text-decoration: none; font-weight: bold; font-size: 14px; display: inline-block;">Reset Password</a>
        </div>
